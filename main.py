...
class CompilerUI(tk.Tk):
    def __init__(self):
        ...
        self.font_style = ("Courier", 12)  # Changed to Courier, a monospace font
        ...
        button_style = {
            "font": ("Courier", 12, "bold"),  # Changed to Courier
            "bg": "#6A9FB5",
            "fg": "white",
            "relief": tk.RAISED,
            "bd": 2,
        ...
        input_label = tk.Label(
            input_frame, text="Input Program Code", font=("Courier", 12, "bold"), bg="#f0f0f0"
        )  # Changed to Courier
        ...
        self.editor_area = scrolledtext.ScrolledText(
            ...
            height=20,
            width=50,
            font=("Courier", 12),  # Changed to Courier
            bd=2,
            relief=tk.SUNKEN,
            padx=10,
            pady=10,
        ...
        output_label = tk.Label(
            output_frame, text="Output / Information", font=("Courier", 12, "bold"), bg="#f0f0f0"
        )  # Changed to Courier
    ...
    def show_tokenized_code(self):
        ...
        self.info_area.insert(tk.END, token_content)
